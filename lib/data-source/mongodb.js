...
class MongoDb {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(mongodb_1.MongoClient);
            this.client = yield mongodb_1.MongoClient.connect(url, options);
    ...
    _findOptionsNormalize(options, extra) {
        ...
        extra = extra ? extra : {};
        if (extra.fields)
            options.projection = extra.fields;
        return options;
    }
    find(collectionName, query, fields, options) {
        ...
        if (query)
            findArgs.push(query);
        if (fields || options)
            findArgs.push(this._findOptionsNormalize(options, { fields }));
