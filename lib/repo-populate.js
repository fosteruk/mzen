...
class RepoPopulate {
    ...
    has(docs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var relatedDocs = yield this.relationRepo.find(options.query, options);
            // Group related docs by parent key
            var values = {};
            relatedDocs.forEach(function (relatedDoc) {
                if (values[relatedDoc[options.key]] == undefined)
                    values[relatedDoc[options.key]] = [];
    ...
    hasManyCount(docs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var results = yield this.relationRepo.aggregate([
                { $match: options.query },
                {
                    $group: {
                        _id: aggregateId,
            ...
            results.forEach(function (result) {
                if (values[result['_id'][options.key]] == undefined)
                    values[result['_id'][options.key]] = 0;
    ...
    embeddedHas(docs, options) {
        ...
        embeddedDocs.forEach(function (embeddedDoc) {
            if (relationIds.indexOf(embeddedDoc[options.key]) != -1) {
                if (values[embeddedDoc[options.key]] == undefined)
                    values[embeddedDoc[options.key]] = [];
    ...
    getRelationIds(docs, options) {
        ...
        const embeddedDocs = object_path_accessor_1.default.getPath(docPath, docs);
                ...
                if (Array.isArray(sourceKey)) {
                    ...
                    sourceKey.forEach(function (sk) {
                        if (values[sk] !== undefined)
                            doc[options.alias].push(values[sk]);
                    });
                }
                else {
...
exports.RepoPopulate = RepoPopulate;
exports.default = RepoPopulate;
//# sourceMappingURL=repo-populate.js.map