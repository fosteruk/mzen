...
class Repo
{
  ...
  findQueryOptions(findArguments)
  {
    ...
    options['stripPrivate'] = (options['stripPrivate'] !== undefined)  ? options['stripPrivate'] : false;
  ...
  {
    this.schema.stripPrivate(objects, findOptions.options['stripPrivate'] ? 'read' : null);
  ...
  insertMany(objects, options)
  {
    ...
    if (options) {
      this.schema.stripPrivate(args[0], options['stripPrivate'] ? 'write' : null);
    }
  ...
  updateMany(criteria, update, options)
  {
    ...
    if (update && update['$set'] && options) {
      this.schema.stripPrivatePaths(update['$set'], options['stripPrivate'] ? 'write' : null);
    }
