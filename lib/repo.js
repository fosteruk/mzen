...
class Repo
{
  ...
  { 
    ...
    flattenedRelationsRecursive.forEach(function(relationConfig){
      ...
      var relationPath = relation['documentPath'].length > 0 ? relation['documentPath'] + '.' + relation['alias'] : relation['alias'];
      ...
      var populate = (options['populate'][relationPath] !== undefined) ? options['populate'][relationPath] : populate;
      if (!populate) return;
